...
The repo contains two files: File <i>rule_based_classification.py</i> contains the code of the classifier with all the rules for matching the formulations. The <i>example.ipynb</i> notebook shows how the classifier can be executed and also contains a brief explanation of how it works.
...
- Stohlmann, Lüders, Tischbirek, Wendel, Hoeft & Reule: Konsolidierung statt Siegeszug. In: Der Staat [accepted].
- Lüders, Wendel, Reule, Stohlmann, Hoeft & Tischbirek: Verhältnismäßigkeit - Proportionality. An annotated dataset of GFCC decisions. [Data set]. Zenodo, 2024. https://doi.org/10.5281/zenodo.10513684